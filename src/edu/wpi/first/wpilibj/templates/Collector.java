 ...
 * detecting infared sensor and the limit switch at the bottom of the
 * collector's motion
 */
public class Collector
{
	...
	/**
	 * Sets the mode of the collector to manualRoller and sets the power at
	 * which the roller motor will be set to the input if the input is not 0
	 *
	...
	/**
	 * Sets the power at which the motor controlling the roller will run when
	 * the collector is in automatic mode
	 *
	...
	/**
	 * Sets the collector's mode to manual raise and sets the power and
	 * direction at which the arm will moved
	 *
	 * @param direction The direction the arm will be moved: -1 causes it to
	 * move down, 0 causes no motion, and 1 causes the arm to move up
	 */
	...
	/**
	 * Controls the collector's states and sets all motor powers, must be called
	 * every loop for the collector to operate
	 */
	void idle()
	{
